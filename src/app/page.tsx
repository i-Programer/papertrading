    ...
    <div className="min-h-screen bg-[#131722] text-[#d1d4dc] flex flex-col justify-between select-none">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 max-w-3xl mx-auto py-12">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-white tracking-tight leading-tight mb-4">
          Hone Your Trading Strategy Without <span className="text-[#26a69a]">Financial Risk</span>
        </h1>
        <p className="text-sm md:text-base text-[#787b86] mb-8 max-w-xl">
          Interactive crypto trading simulation using live streaming data directly from the Binance API. Perfect for practicing market analysis anytime.
        </p>
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6 text-center sm:text-left">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#787b86]">Accurate candlestick chart with super lightweight performance.</p>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#787b86]">Real-time data connection directly via WebSocket.</p>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-[#787b86]">Large simulated balance to test capital risk management.</p>
            </div>
          </div>
        </div>
      </footer>
